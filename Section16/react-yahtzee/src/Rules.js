...
class SmallStraight extends Rule {
    evalRoll = dice => {
        ...
        // small straight must be 4 different dice & only one can be a 1 or a 6 or it cannot have a 1 or 6
        return d.size >= 4 && ((d.has(3) && d.has(4))) &&
        ((d.has(1) && d.has(2))
            || (d.has(2) && d.has(5))
            || (d.has(5) && d.has(6))) ? this.score : 0;
    };
}
